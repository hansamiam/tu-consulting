          ...
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-end">
            ...
            <div className="lg:col-span-4">
              <p className="text-base text-muted-foreground leading-relaxed mb-6">
                ...
                для амбициозных студентов, которые подаются в любую точку мира.
              </p>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-10">
          ...
          <div className="grid sm:grid-cols-2 gap-px bg-border border border-border rounded-lg overflow-hidden">
            {[
              ...
              { n: "03", t: "Кросс-бордер по умолчанию", b: "Учитывает реалии разных стран и развивающихся рынков, а не только США." },
