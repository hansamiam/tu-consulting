      ...
      <section className="bg-primary py-16 sm:py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          >
            ...
            <Input
              placeholder="Поиск по университету, стране или городу..."
              value={search}
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          {showFilters && (
            ...
            >
              <div className="bg-card border border-border rounded-xl p-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                  <Label className="text-xs text-muted-foreground mb-1.5 block">Макс. стоимость (USD/год)</Label>
                  <Input
                    type="number"
                ...
                <div className="flex items-center gap-3">
                  <Switch checked={fullyFunded} onCheckedChange={setFullyFunded} id="fully-funded-ru" />
                  <Label htmlFor="fully-funded-ru" className="text-sm cursor-pointer">Только полное финансирование</Label>
                </div>
                <div className="flex items-center gap-3">
                  <Switch checked={ieltsOptional} onCheckedChange={setIeltsOptional} id="ielts-optional-ru" />
                  <Label htmlFor="ielts-optional-ru" className="text-sm cursor-pointer">IELTS не обязателен</Label>
                </div>
                {activeFilterCount > 0 && (
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <h3 className="text-lg font-heading font-semibold text-foreground mb-2">Университеты не найдены</h3>
                ...
                <Card className="border-border hover:shadow-lg transition-shadow h-full">
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex flex-wrap gap-2 text-xs">
                      {uni.tuition_usd_per_year != null && (
                        <Badge variant="secondary">
                          ...
                          ${uni.tuition_usd_per_year.toLocaleString()}/год
                        </Badge>
                      )}
                    ...
                    {uni.programs?.length > 0 && (
                      <div>
                        <p className="text-xs font-medium text-muted-foreground mb-1.5">Программы ({uni.programs.length})</p>
                    ...
                    {uni.scholarships?.length > 0 && (
                      <div>
                        <p className="text-xs font-medium text-muted-foreground mb-1.5">Стипендии</p>
                        <div className="flex flex-wrap gap-1.5">
