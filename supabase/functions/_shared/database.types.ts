...
//
// Edge-function mirror of src/integrations/supabase/types.ts. Deno fns
// can't reach across the src/ boundary at deploy time, so this file is
// the canonical Database type for everything under supabase/functions/.
// The npm script writes both files in the same run — they cannot drift.
