...
const TopUniAIRu = () => {
  ...
  return (
    // 2026-05-10 v4 — RESET to premium-minimal cream canvas. After
    // three rounds of navy-tuning the user gave full discretion;
    // dropped the navy intake mode entirely. EN/RU parity — see
    // TopUniAI.tsx for the rationale.
