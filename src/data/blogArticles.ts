...
export const blogArticles: BlogArticle[] = [
  ...
  },
  {
    ...
    titleRu: "Полное руководство по стипендиям для иностранных студентов",
    ...
    excerptRu: "Полные и частичные стипендии есть в сотнях университетов мира. Вот как их найти, соответствовать требованиям и написать заявку, которая выиграет.",
    readTime: "7 min",
    readTimeRu: "7 мин",
    category: "Scholarships",
    categoryRu: "Стипендии",
  ...
  },
  {
    ...
    titleRu: "7 вещей, которые я хотел бы знать перед учёбой за рубежом",
    ...
    excerptRu: "Откровенный рассказ от студентов, уехавших из Центральной Азии в топовые университеты. Культурный шок, одиночество, рост — и что бы они сделали иначе.",
    readTime: "5 min",
    readTimeRu: "5 мин",
    category: "Student Life",
    categoryRu: "Жизнь студента",
