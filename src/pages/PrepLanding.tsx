  ...
  const courses = [
    {
      ...
      desc: "Build confidence across all four IELTS sections — Listening, Reading, Writing, and Speaking. Our structured curriculum targets band 6.5–8.0 with timed practice, personalized feedback, and proven test-taking strategies.",
      features: ["Full-length mock exams with scoring", "Essay correction & speaking drills", "Personalized study plan"],
      icon: BookOpen,
    },
    {
      tag: "Test Prep",
      ...
      titleRu: "Подготовка к SAT",
      desc: "Master the math and evidence-based reading & writing sections with a curriculum built around the Digital SAT format. Targeted drills, score diagnostics, and strategies to achieve a 1400+ score.",
      features: ["Digital SAT–aligned practice tests", "Section-by-section score analysis", "Timed drills & test-day strategies"],
      icon: Target,
    },
    {
      tag: "Fluency",
      ...
      desc: "Strengthen your grammar, expand your vocabulary, and develop speaking confidence for academic, professional, and everyday contexts. Tailored lessons ensure you progress at your own pace.",
      features: ["Adaptive curriculum (A2–C1)", "Conversational practice & grammar drills", "Progress tracking & assessments"],
      icon: Globe,
    },
  ];
