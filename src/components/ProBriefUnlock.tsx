...
const COPY = {
  en: {
    ...
    storyHelp: "What shaped your perspective? An obstacle, a turning point, what drives you. Three sentences max — your strategic positioning + essay angles will pull from this.",
    ...
    schoolsHelp: "Comma-separated. The schools section will reference these by name when they appear in the database.",
    schoolsPh: "e.g. Yale, Cambridge, NUS, ETH Zürich",
    submit: "Generate my Pro report",
    skip: "Maybe later",
    badge: "Pro report",
    blurb: "Same engine, deeper context. Strategic positioning, essay angles, and the schools your funding lands you at will reference your story directly.",
  },
  ru: {
    ...
    storyHelp: "Что сформировало ваш взгляд? Препятствие, поворотная точка, что движет вами. Максимум 3 предложения — позиционирование и ракурсы эссе будут отсюда.",
    ...
    schoolsHelp: "Через запятую. Раздел про школы будет ссылаться на них по имени когда они есть в базе.",
    schoolsPh: "напр. Yale, Cambridge, NUS, ETH Zürich",
    submit: "Создать мой Pro-отчёт",
    skip: "Может позже",
    badge: "Pro отчёт",
    blurb: "Тот же движок, глубже контекст. Позиционирование, ракурсы эссе и школы куда приведут стипендии будут ссылаться на вашу историю напрямую.",
  },
} as const;
