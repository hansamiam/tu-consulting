...
const COPY = {
  en: {
     ...
     *  arithmetic. */
    includes: [
      { title: "Personalised strategy brief",            body: "Built by AI from your profile + reviewed against the alumni team's frameworks." },
      ...
      { title: "Live monthly workshops with founders",   body: "Yale · Cambridge · Harvard alumni run live sessions every month — essay clinics, scholarship strategy, country deep-dives." },
    ...
    finalH2a: "First",
    finalH2b: "founding members get the launch price.",
    finalH2c: "",
  ...
  ru: {
    badge: (cap: number) => `Основательная когорта · цена запуска для первых ${cap}`,
    ...
    includes: [
      ...
      { title: "Воркшопы с основателями вживую",          body: "Выпускники Yale, Cambridge, Harvard ведут сессии каждый месяц — эссе-клиники, стратегия, страновые разборы." },
    ...
    perMonth: "/месяц",
    publicNote: "Скидка основательной когорты — по промокоду на оплате.",
    ...
    finalH2a: "Первые",
    finalH2b: "получают цену запуска.",
    finalH2c: "",
    finalLeftPrefix: "мест по цене запуска. После заполнения — $39/мес стандарт.",
